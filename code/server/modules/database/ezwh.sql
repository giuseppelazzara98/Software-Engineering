...
INSERT INTO restockOrders (id, issueDate, state, products, supplierID, transportDate, skuItems) VALUES (1, '2021-11-11 09:33', 'ISSUED', '1,2,3', 1, NULL, '12345678901234567890123456789013,12345678901234567890123456789011,12345678901234567890123456789012,12345678901234567890123456789014');
INSERT INTO restockOrders (id, issueDate, state, products, supplierID, transportDate, skuItems) VALUES (2, '2022-01-22 09:33', 'DELIVERY', '1,2', 2, '2022-01-11', '12345678901234567890123456789017,12345678901234567890123456789016,12345678901234567890123456789014');
INSERT INTO restockOrders (id, issueDate, state, products, supplierID, transportDate, skuItems) VALUES (3, '2021-11-11 11:11', 'DELIVERED', '1,2,3,4', 3, NULL, '12345678901234567890123456789014,12345678901234567890123456789015');
INSERT INTO restockOrders (id, issueDate, state, products, supplierID, transportDate, skuItems) VALUES (4, '2021-10-21 21:13', 'TESTED', '3,4', 2, NULL, '12345678901234567890123456789014');
INSERT INTO restockOrders (id, issueDate, state, products, supplierID, transportDate, skuItems) VALUES (5, '2021-04-06 19:32', 'COMPLETED', '3,4,2', 1, NULL, '12345678901234567890123456789016,12345678901234567890123456789014,12345678901234567890123456789017');
INSERT INTO restockOrders (id, issueDate, state, products, supplierID, transportDate, skuItems) VALUES (6, '2020-04-22 12:22', 'COMPLETEDRETURN', '1,3', 1, NULL, '12345678901234567890123456789015,12345678901234567890123456789015,12345678901234567890123456789012');
...
INSERT INTO SKUItems (RFID, SKUId, Available, DateOfStock) VALUES ('12345678901234567890123456789015', 2, 0, '2021-11-23 11:30');
INSERT INTO SKUItems (RFID, SKUId, Available, DateOfStock) VALUES ('12345678901234567890123456789016', 3, 0, '2021-11-21 15:30');
INSERT INTO SKUItems (RFID, SKUId, Available, DateOfStock) VALUES ('12345678901234567890123456789017', 4, 0, '2022-01-29 12:30');
